      ...
      <section class="hero" data-hero>
        <div class="hero__viewport">
          <div class="hero__track" data-hero-track>
            <!-- 슬라이드 1 -->
            <article class="hero__slide hero__slide--dark" data-hero-slide style="background-image:url('../assets/img/banner-placeholder.svg')">
              <div class="hero__content">
                <h2 class="hero__title">인기 공연 1</h2>
                <p class="hero__subtitle">가장 인기있는 공연</p>
                <a class="btn btn--light" href="#">자세히 보기</a>
              </div>
            </article>
            ...
            <article class="hero__slide hero__slide--dark" data-hero-slide style="background-image:url('../assets/img/banner-placeholder.svg')">
              <div class="hero__content">
                <h2 class="hero__title">인기 공연 2</h2>
                <p class="hero__subtitle">놓치면 후회할 공연</p>
                <a class="btn btn--light" href="#">자세히 보기</a>
              </div>
            </article>
            ...
            <article class="hero__slide hero__slide--dark" data-hero-slide style="background-image:url('../assets/img/banner-placeholder.svg')">
              <div class="hero__content">
                <h2 class="hero__title">인기 공연 3</h2>
                <p class="hero__subtitle">관객들의 선택</p>
                <a class="btn btn--light" href="#">자세히 보기</a>
              </div>
            </article>
            ...
            <article class="hero__slide hero__slide--dark" data-hero-slide style="background-image:url('../assets/img/banner-placeholder.svg')">
              <div class="hero__content">
                <h2 class="hero__title">인기 공연 4</h2>
                <p class="hero__subtitle">프리미엄 공연</p>
                <a class="btn btn--light" href="#">자세히 보기</a>
              </div>
            </article>
          </div>
          ...
          <div class="hot-grid">
            ...
            <article class="hot-featured">
              <a class="poster poster--featured" href="#">
                <img class="poster__img" src="../assets/img/poster-placeholder.svg" alt="대표 인기작 포스터" />
              </a>
            ...
            <div class="hot-cards">
              ...
              <article class="hot-card">
                <a class="poster" href="#">
                  <img class="poster__img" src="../assets/img/poster-placeholder.svg" alt="인기작 포스터" />
          ...
          <div class="opening-grid">
            ...
            <article class="opening-card">
              <a class="opening-card__thumb" href="#">
                <img src="../assets/img/poster-placeholder.svg" alt="포스터" />
